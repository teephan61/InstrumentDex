...
5. Open **Add instrument** to capture identification, tray/set context, photos, a draft processing pathway, Manufacturer IFU/source, and review status. Saving a draft cannot confirm a product or publish processing methods.
...
All manufacturers, products, sources, dates, review/publication claims, and facility data are fictional demo material. Illustrations are schematic and are not validated clinical identification images. The prototype includes no clinical processing parameters, IFUs, persistence, authentication, approval workflow, or operational hold tracking. A real implementation requires actual product mapping evidence, qualified source grounding, review, publication controls, and manufacturer/facility source access.
